...
const services = [
    { id: 1, name: 'アパパネ・Apapane', video: 'apapane_demo/apapaneJp.mp4',release: false, description: 'AI×子ども×エンタメ教育アプリアパパネ', description2: 'やらなあかん教育からやりたい教育への一歩', description3: 'AI(スマホ)とお話しして造る君だけの物語。まさに教育効果も期待できることばのマインクラフト' },
  ];
...
const Products = () => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center rounded-br-3xl">
      <h1 className="text-5xl text-white font-extrabold mt-20">Products Of COROLE</h1>
