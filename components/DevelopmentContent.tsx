...
const achievements = [
  {
    ...
    title: '製造計画立案システム',
    day: '2025/6',
    description: '製造業の製造計画を自動で立案するシステムにより、人手週40時間の手間を削減\nスポーツ用品メーカー様(東証プライム上場、従業員規模連結7000人)',
    image: '/development/25914.png',
    reverse: false,
  },
  {
    id: 2,
    title: '予算実績管理システム',
    day: '2025/7',
    description: 'ExcelやAccessで拠点ごと別々に管理していた予算と実績のシステムを、共通のWebシステムとして構築し、既存の課題を解決\n幼稚園～大学を有する私立学校法人様',
    image: '/development/25914.png',
    reverse: true,
  },
  {
    ...
    title: 'デートプランアプリ',
    day: '2025/1',
    description: 'デートスポット提案アプリの依頼を受けて開発を担当。\nモバイルアプリスタートアップ企業様\nhttps://apps.apple.com/jp/app/sumade/id6737273502',
    image: '/development/25914.png',
    reverse: false,
  },
  {
    ...
    title: 'SNS分析/マーケ調査',
    day: '2025/5',
    description: 'サービスエリアに店舗出店する際のマーケティング分析を行う。SNSから特定の用語の投稿を取得し、内容をAIやデータサイエンスで分析\nサービスエリア飲食・食品製造を手掛けるフードサービス企業様（従業員600人）',
    image: '/development/25914.png',
    reverse: true,
  },
  {
    ...
    title: '図面管理システム',
    day: '2025/2',
    description: '金物のメーカーさんの図面管理システムについて、古いデータベースシステムを新しく再構築\n金物のメーカー様（従業員100人）',
    image: '/development/25914.png',
    reverse: false,
  },
  {
    ...
    title: 'AIコンサルティング',
    day: '2025/2',
    description: 'AIの仕組みや活用方法について従業員の方々に講習会を開く\n不動産管理会社様（従業員130人）',
    image: '/development/25914.png',
    reverse: true,
  },
  {
    ...
    day: '2024/8',
    description: 'Discordにて、セミナー受講生が使える質疑応答AIチャットボットシステムの開発\nAI人材育成／リスキリング支援ベンチャー企業様（従業員50人）',
    image: '/development/25914.png',
    reverse: false,
  },
  {
    ...
    title: 'パズルゲームアプリ',
    day: '2025/6',
    description: '新しい類のパズルゲームアプリの依頼を受けて開発を担当。\n個人のクリエイター様\nhttps://apps.apple.com/jp/app/da-vinci-square/id6742235423',
    image: '/development/25914.png',
    reverse: true,
  },
];
